...
fc1Block = dagnn.Conv('size',[1 1 2048 2048],'hasBias',true,'stride',[1,1],'pad',[0,0,0,0]);
net.addLayer('fc1',fc1Block,{'pool5'},{'fc1'},{'fc1f','fc1b'});
%net.addLayer('fc1bn',dagnn.BatchNorm(),{'fc1'},{'fc1bn'},...
%    {'fc1bn_w','fc1bn_b','fc1bn_m'});
net.addLayer('relu_fc1bn',dagnn.ReLU('leak',0.1),{'fc1'},{'fc1bnx'});

dropoutBlock = dagnn.DropOut('rate',0.5);
net.addLayer('dropout',dropoutBlock,{'fc1bnx'},{'fc1d'},{});

fc751Block = dagnn.Conv('size',[1 1 2048 27],'hasBias',true,'stride',[1,1],'pad',[0,0,0,0]);
